...
class Coyote_trained extends CI_Controller {
...
$options = array();
$result = $service->trainedmodels->predict($this->project_id, $this->trained_model_id, $input, $options);
...
// print the object result
 ...
 $data['result'] = $result;
 $this->load->view('coyote_trained_view', $data);
